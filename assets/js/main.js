...
(function() {
  ...
  // Function to copy email and show copied message
  function copyEmail() {
    const email = "divyanshbhardwaj2273@gmail.com"; // your email
...
// Function to show copied message
  function showCopiedMessage() {
    ...
    // If message box not already created, create it
    if (!copiedMsg) {
      ...
      copiedMsg.style.background = "#4CAF50";
      copiedMsg.style.color = "white";
      copiedMsg.style.padding = "8px 12px";
      copiedMsg.style.borderRadius = "6px";
      copiedMsg.style.fontSize = "14px";
      copiedMsg.style.zIndex = "1000";
      copiedMsg.style.boxShadow = "0px 2px 6px rgba(0,0,0,0.2)";
